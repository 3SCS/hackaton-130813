    ...
    <div class="main_content">                 
     ...
     <a href="#" class="bt_red"><span class="bt_red_lft"></span><strong>Delete items</strong><span class="bt_red_r"></span></a--> 
        ...
        <span class="disabled"><< prev</span><span class="current">1</span><a href="">2</a><a href="">3</a><a href="">4</a><a href="">5</a>…<a href="">10</a><a href="">11</a><a href="">12</a>...<a href="">100</a><a href="">101</a><a href="">next >></a>
         ...
         <h2><strong>Creer compte</strong></h2>
        ...
        <form action="ajoutuser.php" method="post" name="formulaire" class="niceform" onsubmit="return verification();">
            <fieldset>
				<dl><dt><label for="email">Nom:</label></dt>
                        <dd><input type="text" name="nom" id="" size="54" /></dd>
                    </dl>
				<dl><dt><label for="">Prenom:</label></dt>
                        <dd><input type="text" name="prenom" id="" size="54" /></dd>
                    </dl>
				<dl><dt><label for="email">Login:</label></dt>
                        <dd><input type="text" name="login" id="" size="54" /></dd>
                    </dl>
				<dl><dt><label for="email">Mot de passe:</label></dt>
				...
				$nbre=0;
					...
					echo"
						...
						";   ?>
				<?php  echo" </td>
				<dl><dt><label for='email'>$part->libelle:</label></dt>
				<dd><input type='text' name='$part->idq'  size='54' /></dd>       
				</tr>";}?>    
                <dl class="submit">
