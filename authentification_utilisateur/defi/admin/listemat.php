...
<div id="main_container">
    ...
    <div class="main_content">
                    ...
                    <li><a href="">GESTION DES MATERIELS <!--[if IE 7]><!--></a><!--<![endif]-->
                    <!--[if lte IE 6]><table><tr><td><![endif]-->
                        <ul>
                    <li><a href='<?php echo"formc.php";?>'>Ajout </a></li>
                    <li><a  href='<?php echo"listec.php";?>'>liste</a></li>
                     <li><a  href='<?php echo"rec.php";?>'>Recherche</a></li>
                    </ul>
                    <!--[if lte IE 6]></td></tr></table></a><![endif]-->
                    </li>
                    <li><a href="sortie.php">GESTION DES PROJETS<!--[if IE 7]><!--></a><!--<![endif]-->
                    <!--[if lte IE 6]><table><tr><td><![endif]-->
    ...
    <div class="left_content">
            ...
            <div class="sidebarmenu">
                ...
                <a class="menuitem submenuheader" href="">GESTION DES MATERIELS</a>
                 <div class="submenu">
                    <ul>
                ...
                <a class="menuitem submenuheader" href="sortie.php" >GESTION DES PROJETS</a>
                 <div class="submenu">
                    <ul>
                    <li><a href='sortie.php'>Deconexion</a></li>
                    </ul>
                </div>
...
echo"
    ...
    <div class="footer">
    	...
    	<div class="left_footer">BANQUE NATIONALE DU SENEGAL | Produit par <a href="http://facebook.com">Mame Kha et Jules</a></div>
